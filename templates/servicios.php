	<div class="ourServices" id="servicios">
		...
		<div class="allServices">
			<div class="acordeon">
				...
				<div class="bloque">
					<h4 class="h4">Servicios de Streaming</h4>
				</div>
				<div class="bloque">
				...
				<div class="bloque">
					<h4 class="h4">Gestión para empresas y programas informáticos</h4>
				</div>
				<div class="bloque">
					<h4 class="h4">Capacitaciones</h4>
				</div>
				<div class="bloque">
					<h4 class="h4">Otros Servicios</h4>
				</div>
			</div>
				...
				<div class="bloqueInfo activo">
					...
					<div class="division">
						...
						<ul class="listaServicios">
							...
							<li>Conexión de Streaming.</li> 
							<li>Internet por microondas.</li> 
							<li>Redes wifi.</li> 
							<li>Internet para residencias.</li> 
							<li>Internet para eventos.</li>
				...
				<div class="bloqueInfo">
					...
					<div class="division">
						...
						<ul class="listaServicios">
							...
							<li>Protección frente a intrusos.</li> 
							<li>Cerraduras eléctronicas.</li> 
							<li>Conexión con plataformas de vídeo.</li> 
							<li>Control de climatización.</li> 
							<li>Instalación de asistentes virtuales.</li>
							<li>Integración con equipos de audios inteligentes.</li>
							<li>¡Y Mucho Más!</li>
						</ul>
					</div>
				</div>
				...
				<div class="bloqueInfo">
					...
					<div class="division">
						...
						<ul class="listaServicios">
							...
							<li>Web de una sola página.</li> 
							<li>Página adaptadas a móviles.</li> 
							<li>Portales webs.</li>
				...
				<div class="bloqueInfo">
					...
					<div class="division">
						...
						<ul class="listaServicios">
							...
							<li>Posicionamiento de la marca.</li> 
							<li>Análisis de resultados y mejoras continuas.</li> 
							<li>Diseño y ejecución de campañas ADS.</li> 
							<li>Diseño y difusión de contenidos.</li>
							<li>Identidad corporativa para tus perfiles.</li>
							<li>¡Y Mucho Más!</li>
						</ul>
					</div>
				</div>
				<div class="bloqueInfo">
					<h2>Gestión para empresas y programas informáticos</h2>
					<p class="infoInfo">El mundo digital ofrece una gran cantidad de opciones para hacer las tareas de gestión empresarial de una forma sencilla. Ya sea para la optimización de trabajos repetitivos, mejorar el acceso a la información o gestión de personal. Los software para empresas pueden convertirse en la vía de éxito para cualquier negocio. Para facilitar los objetivos diarios y ahorrar tiempo contamos con una amplia gama de opciones para gestionar y digitalizar tu empresa.
					</p>
					...
					<div class="division">
						...
						<ul class="listaServicios">
							...
							<li>Organizador de proyectos y equipos de trabajos.</li> 
							<li>Programas de redacción.</li> 
							<li>Lector de documentos.</li> 
